...
/*
正确的链接：
http://localhost:8080/51mh?user_name=枯藤&tag_line=9&tag_line2=33&locale=zh

http://localhost:8080/51mh?user_name=枯藤&tag_line=9&tag_line2=3&locale=en 返回英文的验证信息

http://localhost:8080/51mh?user_name=枯藤&tag_line=9&tag_line2=3&locale=zh 返回中文的验证信息
 */